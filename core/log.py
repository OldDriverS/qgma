...
import os,sys
import traceback
import logging # 日志模块，需安装
import colorlog # 彩色日志，需安装
...
# 最大创建日志数量
class Logger:
    def Set_Log(log_file_name='gqapi.log', file_log_level='debug', console_log_level='debug', max_bytes=1*1024*1024, backup_count=9):
